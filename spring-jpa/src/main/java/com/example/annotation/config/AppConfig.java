...
@Configuration
@ComponentScan(basePackages = {"com.example.annotation", "com.example.relationship.onetoone", "com.example.relationship.onetomany", "com.example.relationship.manytomany"}) // Replaces <context:component-scan>
